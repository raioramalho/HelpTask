...
//essa pagina é somente do admin.
    ...
    if (password_verify($_COOKIE['usuario'], $_COOKIE['verify'])){
...
<!-- The drawer is always open in large screens. The header is always shown,
  ...
  <div class="mdl-layout__drawer">
    ...
    <a class="mdl-navigation__link"><i class="material-icons">account_circle</i><?php echo " - Olá: <b>". $_COOKIE['usuario'] ."</b>";?></a>
